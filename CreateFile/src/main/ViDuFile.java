...
public class ViDuFile {
    ...
    public void inDanhSachCacFileCon(){
        if(this.file.isDirectory()){
            System.out.println("Các tập tin con/ Thư mục con: ");
           File[] mangCon = this.file.listFiles();
            for (File file:mangCon) {
                System.out.println(file.getAbsoluteFile());
            }
        }else {
            System.out.println("Đây là tập tin, không có file con.");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2. Kiểm tra file có đọc: ");
            ...
            System.out.println("8. In ra cây thư muc: ");
